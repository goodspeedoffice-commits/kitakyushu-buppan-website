...
公開ページで使う写真の出どころを記録する。画像はすべて `public/images/site/` に保存し、外部サイトの終了で表示が消えないようにする。
...
いずれも2026-08-20にPexelsの各写真ページで「Free to use」を確認した。

| 保存ファイル | 提供者 | 配布ページ |
|---|---|---|
| `ecommerce-packing-stock.avif` | Kampus Production | https://www.pexels.com/photo/woman-using-brown-box-for-packaging-7289719/ |
| `consulting-meeting-stock.avif` | MART PRODUCTION | https://www.pexels.com/photo/businesspeople-in-a-meeting-7643721/ |
